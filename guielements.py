...
lineup_button = Button(button_x,senior_squad_button.rect.bottom + button_spacing,button_width,button_height, "Lineup", very_small_font, WHITE, BLACK, GRAY)
tactics_button = Button(button_x,lineup_button.rect.bottom + button_spacing,button_width,button_height, "Tactics", very_small_font, WHITE, BLACK, GRAY)
