...
SKIN_TONES =    [((255, 204, 153),(204, 153, 102)),
    ((255, 207, 187),(244, 180, 146)),((245, 190, 157),(230, 150, 126)),
    ((231, 189, 152),(229, 163, 121)),((216, 122, 97),(149, 95, 79)),
    ((205, 120, 92),(149, 95, 79))]

HAIR_COLORS = [((255, 0, 0),(240,90,90)), ((200, 110, 110),(210,50,50)), ((210,50,50),(200, 110, 110)),
               ((255, 204, 0),(240,150,0)), 
               ((200, 200, 200),(140,140,140)),
               ((75,55,55),(132,105,95)),((65,35,35),(102,75,65)),((65,35,35),(92,45,45)),
               ((102,75,65),(65,35,35))]
EYE_COLORS = [(60, 60, 200), (86,70,55), (85,126,86)]
WHITE = (255,255,255)
BLACK = (0,0,0)
MOUTH_COLORS = [(255, 0, 0), (210, 150, 150), (200, 100, 100), (170, 100,120)]

class Face:
    #def __init__(self, shape: int, skin_tone: int, hair: dict, eyes: dict) -> None:
    def __init__(self, face_dict: dict) -> None: 
        self.shape:int = face_dict.get('shape', 1)
        self.skin_tone: int = face_dict.get('skin_tone', 1)
        self.hair: dict = face_dict.get('hair', {'shape': 1, 'color': 0})
        self.eyes: dict = face_dict.get('eyes', {'shape': 1, 'width': 30, 'color': 0, 'brow': 0})
        self.nose: int = face_dict.get('nose', 1)
        self.mouth: dict = face_dict.get('mouth', {'shape': 1, 'color': 0})
        self.ears: int = face_dict.get('ears', 1)
    ...
    def draw_face(self) -> pygame.Surface:
        ...
        face_surface = self.draw_ears(face_surface)
        match self.shape:
            case 1:
            ...
            case 3:
                pygame.draw.ellipse(face_surface, skin_tones[1], [50, 43, 200, 230], 0)
                pygame.draw.ellipse(face_surface, skin_tones[0], [50, 40, 200, 230], 0)
            case 4:
                pygame.draw.ellipse(face_surface, skin_tones[1], [50, 43, 200, 230], 0)
                pygame.draw.ellipse(face_surface, skin_tones[1], [110, 213, 75, 75], 0)
                pygame.draw.ellipse(face_surface, skin_tones[0], [50, 40, 200, 230], 0)
                pygame.draw.ellipse(face_surface, skin_tones[0], [110, 210, 75, 75], 0)
            case 5:
    ...
    def draw_hair(self, face_surface: pygame.Surface) -> pygame.Surface:
        hair_colors = HAIR_COLORS[self.hair.get("color", 1)]
        match self.shape:
            case 1:
                vertical_offset=20
            case 2:
        ...
        match self.hair.get("shape"):
            ...
            case 4:       
                pygame.draw.polygon(face_surface, hair_colors[0], [(49,133+vertical_offset),
                                                        ...
                                                        (89,35+vertical_offset),
                                                        (113,32+vertical_offset),
                                                        (100,30+vertical_offset),(85,25+vertical_offset),(78,32+vertical_offset),
                                                        (100,23+vertical_offset),
                                                        (134,28+vertical_offset),(164,30+vertical_offset),
                                                        (194,35+vertical_offset),
                                                        (225,43+vertical_offset),
                                                        (233,59+vertical_offset),(237,70+vertical_offset),
    ...
    def draw_eyes(self, face_surface: pygame.Surface) -> pygame.Surface:
        ...
        eye_color = EYE_COLORS[self.eyes.get("color",1)]
        skin_tones = SKIN_TONES[self.skin_tone]

        match self.eyes.get("shape"):
            case 1:
                pygame.draw.ellipse(face_surface, WHITE, [135-self.eyes.get("width",30), 100+vertical_offset, 30, 30], 0)
                pygame.draw.ellipse(face_surface, eye_color, [140-self.eyes.get("width",30), 105+vertical_offset, 20, 20], 0)
                pygame.draw.ellipse(face_surface, BLACK, [145-self.eyes.get("width",30), 110+vertical_offset, 10, 10], 0)
                pygame.draw.arc(face_surface, skin_tones[1], [130-self.eyes.get("width",30),100+vertical_offset,45,25], 0, pi, width=5)
                pygame.draw.arc(face_surface, skin_tones[1], [130-self.eyes.get("width",30),105+vertical_offset,40,15], 0, pi, width=5)
                pygame.draw.arc(face_surface, skin_tones[0], [130-self.eyes.get("width",30),117+vertical_offset,40,15], pi, 0, width=5)
                pygame.draw.ellipse(face_surface, WHITE, [135+self.eyes.get("width",30), 100+vertical_offset, 30, 30], 0)
                pygame.draw.ellipse(face_surface, eye_color, [140+self.eyes.get("width",30), 105+vertical_offset, 20, 20], 0)
                pygame.draw.ellipse(face_surface, BLACK, [145+self.eyes.get("width",30), 110+vertical_offset, 10, 10], 0)
                pygame.draw.arc(face_surface, skin_tones[1], [130+self.eyes.get("width",30),100+vertical_offset,45,25], 0, pi, width=5)
            ...
            case 2:
                ...
                pygame.draw.ellipse(face_surface, eye_color, [140-self.eyes.get("width",30), 105+vertical_offset, 20, 20], 0)
                pygame.draw.ellipse(face_surface, BLACK, [145-self.eyes.get("width",30), 110+vertical_offset, 10, 10], 0)
                pygame.draw.arc(face_surface, skin_tones[0], [130-self.eyes.get("width",30),100+vertical_offset,45,25], 0, pi, width=5)
                pygame.draw.arc(face_surface, skin_tones[1], [130-self.eyes.get("width",30),102+vertical_offset,45,25], 0, pi, width=7)
                pygame.draw.arc(face_surface, skin_tones[1], [130-self.eyes.get("width",30),107+vertical_offset,40,15], 0, pi, width=7)
                pygame.draw.arc(face_surface, skin_tones[0], [130-self.eyes.get("width",30),117+vertical_offset,40,15], pi, 0, width=5)
                pygame.draw.arc(face_surface, skin_tones[0], [130-self.eyes.get("width",30),116+vertical_offset,40,15], pi, 0, width=7)
                pygame.draw.ellipse(face_surface, WHITE, [135+self.eyes.get("width",30), 100+vertical_offset, 30, 30], 0)
                pygame.draw.ellipse(face_surface, eye_color, [140+self.eyes.get("width",30), 105+vertical_offset, 20, 20], 0)
                pygame.draw.ellipse(face_surface, BLACK, [145+self.eyes.get("width",30), 110+vertical_offset, 10, 10], 0)
                pygame.draw.arc(face_surface, skin_tones[0], [130+self.eyes.get("width",30),100+vertical_offset,45,25], 0, pi, width=5)
                pygame.draw.arc(face_surface, skin_tones[1], [130+self.eyes.get("width",30),103+vertical_offset,45,25], 0, pi, width=5)
                pygame.draw.arc(face_surface, skin_tones[1], [130+self.eyes.get("width",30),108+vertical_offset,40,15], 0, pi, width=5)
                pygame.draw.arc(face_surface, skin_tones[0], [130+self.eyes.get("width",30),114+vertical_offset,40,15], pi, 0, width=5)
                pygame.draw.arc(face_surface, skin_tones[0], [130+self.eyes.get("width",30),117+vertical_offset,40,15], pi, 0, width=5)
            case 3:
                pygame.draw.ellipse(face_surface, WHITE, [135-self.eyes.get("width",30), 100+vertical_offset, 30, 40], 0)
                pygame.draw.ellipse(face_surface, eye_color, [140-self.eyes.get("width",30), 105+vertical_offset, 20, 30], 0)
                pygame.draw.ellipse(face_surface, BLACK, [145-self.eyes.get("width",30), 115+vertical_offset, 10, 10], 0)
                pygame.draw.arc(face_surface, skin_tones[1], [130-self.eyes.get("width",30),100+vertical_offset,45,25], 0, pi, width=5)
                pygame.draw.arc(face_surface, skin_tones[1], [130-self.eyes.get("width",30),105+vertical_offset,40,15], 0, pi, width=5)
                pygame.draw.ellipse(face_surface, WHITE, [135+self.eyes.get("width",30), 100+vertical_offset, 30, 40], 0)
                pygame.draw.ellipse(face_surface, eye_color, [140+self.eyes.get("width",30), 105+vertical_offset, 20, 30], 0)
                ...
                pygame.draw.arc(face_surface, skin_tones[1], [130+self.eyes.get("width",30),105+vertical_offset,40,15], 0, pi, width=5)
            case 4:
                pygame.draw.ellipse(face_surface, WHITE, [130-self.eyes.get("width",30), 100+vertical_offset, 40, 30], 0)
                pygame.draw.ellipse(face_surface, eye_color, [140-self.eyes.get("width",30), 105+vertical_offset, 20, 20], 0)
                pygame.draw.ellipse(face_surface, BLACK, [145-self.eyes.get("width",30), 110+vertical_offset, 10, 10], 0)
                pygame.draw.arc(face_surface, skin_tones[1], [130-self.eyes.get("width",30),100+vertical_offset,45,25], 0, pi, width=5)
                pygame.draw.arc(face_surface, skin_tones[0], [130-self.eyes.get("width",30),117+vertical_offset,40,15], pi, 0, width=3)
                pygame.draw.ellipse(face_surface, WHITE, [130+self.eyes.get("width",30), 100+vertical_offset, 40, 30], 0)
                pygame.draw.ellipse(face_surface, eye_color, [140+self.eyes.get("width",30), 105+vertical_offset, 20, 20], 0)
                pygame.draw.ellipse(face_surface, BLACK, [145+self.eyes.get("width",30), 110+vertical_offset, 10, 10], 0)
                pygame.draw.arc(face_surface, skin_tones[1], [130+self.eyes.get("width",30),100+vertical_offset,45,25], 0, pi, width=5)
    ...
    def draw_eyebrows(self, face_surface: pygame.Surface) -> pygame.Surface:
        ...
        match self.eyes.get("brow"):
            case 1:
                pygame.draw.arc(face_surface, hair_colors[0], [125-self.eyes.get("width",30), 92+vertical_offset,50,25], 2*pi, pi, width=5)
                pygame.draw.arc(face_surface, hair_colors[0], [125+self.eyes.get("width",30), 92+vertical_offset,50,25], 2*pi, pi, width=5)
            case 2:
                pygame.draw.arc(face_surface, hair_colors[1], [125-self.eyes.get("width",30), 92+vertical_offset,50,25], 2*pi, pi, width=5)
                pygame.draw.arc(face_surface, hair_colors[1], [125+self.eyes.get("width",30), 92+vertical_offset,50,25], 2*pi, pi, width=5)
            case 3:
                pygame.draw.arc(face_surface, hair_colors[0], [135-self.eyes.get("width",30), 92+vertical_offset,40,15], 0.1, pi-0.1, width=5)
                pygame.draw.arc(face_surface, hair_colors[0], [125+self.eyes.get("width",30), 92+vertical_offset,40,15], 0.1, pi-0.1, width=5)
            case 4:
                pygame.draw.arc(face_surface, hair_colors[1], [135-self.eyes.get("width",30), 92+vertical_offset,40,15], 0.1, pi-0.1, width=5)
                pygame.draw.arc(face_surface, hair_colors[1], [125+self.eyes.get("width",30), 92+vertical_offset,40,15], 0.1, pi-0.1, width=5)
    ...
    def draw_nose(self, face_surface: pygame.Surface) -> pygame.Surface:
        ...
        match self.nose:
            ...
            case 2:        
                pygame.draw.arc(face_surface, skin_tones[1], [155,130,20,45], pi, 3*pi/2, width=3)
                pygame.draw.arc(face_surface, skin_tones[1], [125,130,20,45], 3*pi/2, 0, width=3)
                pygame.draw.arc(face_surface, skin_tones[1], [135,175,35,10], 0, pi, width=3)
                pygame.draw.ellipse(face_surface, skin_tones[1], [145,180,5,5], 0)
                pygame.draw.ellipse(face_surface, skin_tones[1], [155,180,5,5], 0)
            case 3:
    ...
    def draw_ears(self, face_surface: pygame.Surface) -> pygame.Surface:
        skin_tones = SKIN_TONES[self.skin_tone]
        match self.ears:
            case 1:
                pygame.draw.ellipse(face_surface, skin_tones[0], [40,130,15,45], 0)
                pygame.draw.ellipse(face_surface, skin_tones[1], [43,140,10,25], 0)
                pygame.draw.ellipse(face_surface, skin_tones[0], [245,130,15,45], 0)
                pygame.draw.ellipse(face_surface, skin_tones[1], [248,140,10,25], 0)
            case 2:
                pygame.draw.ellipse(face_surface, skin_tones[0], [40,130,15,65], 0)
    ...
    def draw_mouth(self, face_surface: pygame.Surface) -> pygame.Surface:
        ...
        mouth_color = MOUTH_COLORS[self.mouth.get("color",1)]
        match self.mouth.get("shape"):
            ...
            case 4:
                ...
                pygame.draw.arc(face_surface, mouth_color, [120,215+vertical_offset,65,15], pi, 0, width=8)
